...
are enough for PR \cite{intpp}. PP are the largest class of models available, and there are
...
generator \cite{Duvenaud}. This whole notion couldn't be better explained than in this text by Freer and
...
\ref{art}, but many more exist, such as as Figaro \cite{figaro} (hosted in Scala),
...
empowering the user to write his own models. Rather than using most of his
