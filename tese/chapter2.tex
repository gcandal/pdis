...
Even if the goal os VP is clear (to make programming more understandable, ensure
...
but rather a dataflow VPE approach, as described in \ref{} and b) screens
are getting bigger and with higher resolutions \cite{}, a low-end screen by today's standards
...
\cite{empstud}\cite{cunniff1986does}\cite{Carlisle2005}.
...
\subsection{Eclispe Android UI Plugin}

\subsection{Eclipse Window Builder Plugin}
