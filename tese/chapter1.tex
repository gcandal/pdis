...
In the second alternativa one common way to approach it is by using bayesian reasoning,
...
intuiton provided by other tools they are accustomed to. In a poll made to find
